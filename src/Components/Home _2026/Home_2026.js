...
function Home_2026() {
  ...
  if (!jogo.inicio || jogo.inicio === "-") return new Date(0);

  const [dia, mes, ano] = jogo.inicio.split("/");
  return new Date(ano, mes - 1, dia);
  }

  function ordenarPorInicio(a, b) {
    return parseDataInicio(a) - parseDataInicio(b);
  }
...
{menuAberto && (
  <div className="menu-flutuante" ref={menuRef}>
    ...
    <div className="menu-grid">
      <button onClick={() => navigate("/Home_2025")}>🏠 2025</button>
    </div>
    ...
    <div className="menu-grid">
      ...
      <button onClick={() => setOrdenacao("tempo-asc")}>⏱️ Tempo</button>
      <button onClick={() => setOrdenacao("rank-asc")}>🏆 Rank 2026</button>
