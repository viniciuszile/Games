...
function Home_2025() {
  ...
  useEffect(() => {
    fetch(
      "https://raw.githubusercontent.com/viniciuszile/Games/refs/heads/Jogos-2026-v1/public/Data/jogos_2025.json"
    )
      .then((res) => {
      ...
      {menuAberto && (
        <div className="menu-flutuante" ref={menuRef}>
            ...
            <div className="menu-grid">
              <button onClick={() => navigate("/")}>🏠 2026</button>
              <button onClick={() => navigate("/top3")}>🏆 Top 3 (2025)</button>
